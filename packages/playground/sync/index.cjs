"use strict";Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});const u=require("@php-wasm/logger"),c=require("@php-wasm/util"),_=require("@php-wasm/fs-journal"),$=`<?php
...
playground_sync_start();`;async function p(e){await e.fileExists("/wordpress/wp-content/mu-plugins")||await e.mkdir("/wordpress/wp-content/mu-plugins"),await e.writeFile("/wordpress/wp-content/mu-plugins/sync-mu-plugin.php",$)}async function m(e,n,t={}){const s=await e.run({code:`<?php
